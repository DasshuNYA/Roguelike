...
class Event
{
   public:
    ...
    {
        int x;  ///< X position of the mouse pointer, relative to the left of
                ///< the owner window
    ...
    struct MouseWheelScrollEvent
    {
        ...
        float delta;         ///< Wheel offset (positive is up/left, negative is
                      ///< down/right). High-precision mice may use non-integral
                      ///< offsets.
        int x;  ///< X position of the mouse pointer, relative to the left of
                ///< the owner window
        int y;  ///< Y position of the mouse pointer, relative to the top of the
    ...
    {
        unsigned int
            finger;  ///< Index of the finger in case of multi-touch events
        int x;  ///< X position of the touch, relative to the left of the owner
                ///< window
        int y;  ///< Y position of the touch, relative to the top of the owner
                ///< window
    };
    ...
    enum EventType
    {
        ...
        MouseEntered,  ///< The mouse cursor entered the area of the window (no
                       ///< data)
    ...
    union
    {
        ...
        MouseWheelScrollEvent
            mouseWheelScroll;            ///< Mouse wheel event parameters
                                         ///< (Event::MouseWheelScrolled)
        JoystickMoveEvent joystickMove;  ///< Joystick move event parameters
                                         ///< (Event::JoystickMoved)
        JoystickButtonEvent
            joystickButton;  ///< Joystick button event parameters
