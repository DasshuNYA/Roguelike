...
namespace XYZRoguelike
{
	...
	float LevelBuilder::GetPlayerSpawnX() const
	{
		return startX + 3 * tileSize;
	}

	float LevelBuilder::GetPlayerSpawnY() const
	{
		return startY + 4 * tileSize;
	}

	float LevelBuilder::GetEnemySpawnX() const
	{
		return startX + 8 * tileSize;
	}

	float LevelBuilder::GetEnemySpawnY() const
	{
		return startY + 4 * tileSize;
	}
}